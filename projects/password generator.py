...
words = [
    ...
    "apricot", "blueberry", "cantaloupe", "dragonfruit", "eggplant", "feijoa", "guava",
    "huckleberry", "jackfruit", "kumquat", "lime", "mulberry", "nectar", "olive", "peach",
    "plum", "pomegranate", "quinoa", "rhubarb", "soursop", "tomato", "uva", "voavanga",
    "walnut", "ximenia", "yuzu", "zebrawood", "almond", "blackberry", "coconut", "durian",
    "elderflower", "figwort", "grapefruit", "hazelnut", "indigo", "jambul", "kiwano",
    "lychee", "mandarin", "nutmeg", "oregano", "persimmon", "quandong", "rosehip",
    "sapodilla", "tamarind", "ugni", "valencia", "watercress", "xylocarp", "yellowwood",
    "zostera", "acerola", "bilberry", "clementine", "dewberry", "endive", "fennel",
    "gooseberry", "horseradish", "iceberg", "jalapeno", "kale", "lettuce", "mangosteen",
    "navel", "okra", "parsley", "radish", "spinach", "turnip", "upland", "vanilla",
    "wasabi", "xanthan", "yambean", "zinnia", "abecedarian", "absquatulate", "adumbrate", "aeonian",
    "aesthete", "alacrity", "amanuensis",
    "antediluvian", "apocryphal", "apoplectic", "apotheosis", "argosy", "asperity", "assiduous",
    "ataraxia", "autochthonous", "balderdash", "bellwether", "blatherskite", "bloviate",
    "borborygmus", "cacophony", "callipygian", "calumny", "catawampus", "celerity", "chiaroscuro",
    "circumlocution", "circumspect", "clishmaclaver", "cockalorum", "collywobbles", "concinnity",
    "conflagration", "contumacious", "coruscate", "crepuscular", "defenestration", "desideratum",
    "diaphanous", "discombobulate", "disquisition", "ebullient", "effulgent", "egregious",
    "eleemosynary", "empyreal", "ephemeral", "epistolary", "equanimity", "erstwhile", "etiolate",
    "eucatastrophe", "euphony", "excoriate", "exegesis", "farrago", "fatuous", "feckless",
    "flibbertigibbet", "flummox", "folderol", "fustian", "gallimaufry", "gasconade", "gossamer",
    "haboob", "hagiography", "halcyon", "heuristic", "hobbledehoy", "hoi_polloi", "horripilation",
    "ignominious", "imbroglio", "impecunious", "incunabula", "ineffable", "inimical", "insouciant",
    "internecine", "jejune", "juxtaposition", "kaleidoscopic", "kerfuffle", "lachrymose",
    "lackadaisical", "lagniappe", "limerence", "logorrhea", "lollapalooza", "lugubrious",
    "magniloquent", "malapropism", "mellifluous", "meretricious", "misanthrope", "moue",
    "nefarious", "neophyte", "nugatory", "obfuscate", "obstreperous", "onomatopoeia", "otiose",
    "panacea", "panoply", "parsimony", "penumbra", "perfidious", "persnickety", "phantasmagoria",
    "plethora", "prestidigitation", "profligate", "propinquity", "pusillanimous", "quagmire",
    "quixotic", "raconteur", "recalcitrant", "recondite", "redolent", "refulgent", "risible",
    "salubrious", "sanguine", "sesquipedalian", "serendipity", "somnambulist", "sonder",
    "soporific", "susurrus", "sycophant", "tatterdemalion", "tintinnabulation", "truculent",
    "ubiquitous", "ululation", "unctuous", "usurp", "uxorious", "verisimilitude", "vicissitude",
    "vociferous", "wanderlust", "whippersnapper", "whirligig", "xenophobia", "yesteryear",
    "zephyr", "zeitgeist", "zoolatry",
    "about", "above", "accept", "account", "across", "act", "action", "activity", "actually", "add",
    ...
    "entire", "environment", "especially", "establish", "even", "evening", "event", "ever", "every", "everybody",
    "everyone", "everything", "evidence", "exactly", "example", "executive", "exist", "expect", "experience", "expert",
    "explain", "eye", "face", "fact", "factor", "fail", "fall", "family", "far", "fast",
...
seperators = [".", ",", "/", "'", '"', ";", ":", "+", "=", "_", "-", "0", "9", "8", "*", "7", "&", "6", "^", "5", "%", "4", "$", "3", "#", "2", "@", "1", "!", "?", "~"]
def main():
    num_of_words = int(input("How many words do you want in your password? "))
    if num_of_words < 1:
        print("Please enter at least 1 word.")
        main()
    password_words = [random.choice(words) for _ in range(num_of_words)]
    random_seps = [random.choice(seperators) for _ in range(num_of_words - 1)]
    password = ""
    for i, word in enumerate(password_words):
        password += word
        if i < len(random_seps):
            password += random_seps[i]
    print(password)
main()
